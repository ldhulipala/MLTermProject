...
Pittsburgh, PA 15213 \\
\texttt{\{ldhulipa, wangzih, hgifford\}@andrew.cmu.edu} \\
}
...
to represent and classify images into categories. 
\end{abstract}
...
A fundamental step for many object recognition algorithms is to learn heirarchies
...
algorithms to fully unsupervised learning algorithms. Nigam et al. describe how to 
...
Another recent approach for feature learning pioneered by Raina et al. runs under the 
moniker of Self-Taught Learning. Self-Taught learning works similarly to the EM-based 
