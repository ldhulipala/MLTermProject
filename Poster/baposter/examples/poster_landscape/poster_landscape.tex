...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{}{name=graph,column=1,row=0, below=clustering}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
  \begin{center}
  \includegraphics[width=0.9\colwidth]{figs/eigs192.png}
  \captionof{figure}{All 192 eigenvectors from a selection of $8 \times 8$ patches.}
%  \caption{All 192 eigenvectors from a selection of $8 \times 8$ patches.}
  \end{center}
%  \includegraphics[height=0.4\colwidth]{figs/patches100.png}
